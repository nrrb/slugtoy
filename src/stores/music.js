...
export const useMusicStore = defineStore('music', () => {
  ...
  // Sound effects are now generated on demand, no need for cache
  ...
  // Create a toot sound effect
  const createTootEffect = () => {
